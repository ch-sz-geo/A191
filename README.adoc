...
[discrete]
= Masterkatalog (A191)
Sie befinden sich auf der Startseite des Themas **"Masterkatalog (A191)"**. Über folgende Links gelangen Sie zu weiteren Informationen:

* https://ch-sz-geo.github.io/A191/[Daten, Datenmodell, Modellbeschreibung, Erfassungsrichtlinie usw.] zu diesem Thema
